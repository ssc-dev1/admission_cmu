    ...
    editor.addButton('math_editor',
        {
	        ...
	        image       : 'http://localhost:8069/aspl_web_tinymce_editor/static/lib/tinymce/plugins/math_editor/img/math.png',
	        onclick     : function() {
				editor.windowManager.open({
			   		title: "Math Editor",
					url: 'http://localhost:8069/aspl_web_tinymce_editor/static/lib/tinymce/plugins/math_editor/index.html',
					width: editor_width,
					height: 400
				});
			}
