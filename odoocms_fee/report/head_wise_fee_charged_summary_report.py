...
class HeadWiseFeeChargedSummaryReport(models.AbstractModel):
    _name = 'report.odoocms_fee.head_wise_fee_charged_summary_report'
    ...
    def _get_report_values(self, docsid, data=None):
        ...
        res = lines
        report = self.env['ir.actions.report']._get_report_from_name('odoocms_fee.head_wise_fee_charged_summary_report')
        docargs = {
            'doc_ids': [],
