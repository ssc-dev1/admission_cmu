...
class product_uom_class(models.Model):
    ...
    localuom = fields.One2many('localproduct.uom', 'localcategory_id', 'Per Product Unit of Measure',index=True,required=False, help="Unit of Measure used for this products stock operation.")
...
class ProductTemplate(models.Model):
    ...
    uom_class = fields.Many2one('productuom.class', 'Per Product UOM Conversion Class', ondelete='set null',required=False, help="Unit of Measure class for Per Product UOM")
