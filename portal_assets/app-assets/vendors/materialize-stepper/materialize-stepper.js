        ...
        _classCallCheck(this, E),
            ...
            _defineProperty(this, "nextStep", function (e, t, n) {
                ...
                return E && !f()
                    ? a()
                    : P && !t
                    ? (u && !h.step.dataset.nopreloader && s(), void window[P](v, o, h.step.querySelector(".".concat(l.STEPCONTENT))))
                    : (h.step.classList.add(l.DONESTEP), c(y, e), void p.dispatchEvent(d.NEXTSTEP));
            }),
            ...
            _defineProperty(this, "activateFeedback", function () {
                ...
                s.classList.add(t.FEEDBACKINGSTEP),
                    s.getElementsByClassName(t.STEPCONTENT)[0].insertAdjacentHTML("afterBegin", '<div class="'.concat(t.PRELOADERWRAPPER, '">').concat(n.feedbackPreloader, "</div>")),
            ...
            _defineProperty(this, "getSteps", function () {
                ...
                return { steps: n, active: { step: i, index: Array.prototype.indexOf.call(n, i) } };
            }),
    ...
    return (
        _createClass(E, null, [
            ...
            },
            {
                ...
                value: function (e, t) {
                    for (var n = t.querySelectorAll("input, textarea, select"), i = 0; i < n.length; i++) if (!n[i].checkValidity()) return !1;
                    return !0;
                },
            },
            {
