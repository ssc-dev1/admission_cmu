                    ...
                    try:
                        ...
                        if not admission_no:
                            ...
                            if program_batch:
                                ...
                                program_sequence_number = student_adm_program.sequence_number
                                ...
                                # reg_no = 'L1' + applicant.term_id.short_code + student.program_id.short_code + str(program_sequence_number).zfill(4)
                                reg_no = student.program_id.short_code + student_adm_profile.term_id.short_code + str(student.program_id.sequence_number).zfill(3)
